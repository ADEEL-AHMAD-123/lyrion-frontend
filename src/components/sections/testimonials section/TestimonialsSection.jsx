...
const testimonials = [
    {
      text: "Lyrion Al has completely transformed the way we handle automation. The platform is incredibly easy to use, and we were able to set up our first Al bot in no time. The seamless integrations with our CRM and email tools have saved us hours of manual work every week!",
      author: "Handan Majid",
      role: "Founder",
      avatar: avatar1,
    },
  ...
  return (
    <section className="testimonials-section">
      <div className="section-header">
        ...
        <p>
          Explore real experiences from our valued customers and discover how Lyrión Al
